...
# Wir erstellen ein Histogramm (ohne Plotten) und speichere es in der Variable h1.
h1 <- hist(demstd$band1, breaks = 20, plot = FALSE) 
# Wir ersetzen die Dichte mit der selbst berechneten relativen Häufigkeit.
h1$density <- h1$counts / length(demstd$band1)  
# Wir plotten das Ergbebnis.

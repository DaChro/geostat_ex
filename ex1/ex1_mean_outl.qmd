...
# Beobachtungen, bei denen die Semesterangaben größer oder gleich 10 Semester sind,
# und berechnet im Anschluss den Mittelwert und Median des bereinigten Datensatzes:
...
# Alternativ können auch getrimmte Mittelwerte betrachtet werden um Ausreißer zu beseitigen. 
# Führe folgende Befehle aus und beachte, wie unterschiedliche Werte für 'trim' den 
# resultierenden Mittelwert beeinflussen:
